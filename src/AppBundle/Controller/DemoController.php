...
class DemoController extends Controller
{
    ...
    public function loginAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo:login.html.twig', [
            'error' => $error,
            '_username' => $_username,
            '_password' => $_password,
        ]);
    ...
    public function authorizeAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo:authorize.html.twig', [
            'client_id' => $clientId,
            'username' => $username,
            'scopes' => $scope,
    ...
    public function requestCodeAction(Request $request)
    {
        ...
        $url = Request::create($request->getUriForPath('/authorize'), 'GET', $parameters)->getUri();
    ...
    public function responseTypeCodeAction(Request $request)
    {
        ...
        $tokenPath = $this->get('router')->generate('app_grant_type_authorization_code', [
            'code' => $authorizationResponse['code'],
        ]);

        return $this->render('AppBundle:demo/response_type:code.html.twig', [
    ...
    public function responseTypeTokenAction(Request $request)
    {
        ...
        $modelPath = $this->get('router')->generate('app_resource_type_model', [
            'access_token' => $accessTokenResponse['access_token'],
        ]);
        $debugPath = $this->get('router')->generate('app_resource_type_debug_endpoint', [
            'access_token' => $accessTokenResponse['access_token'],
        ]);

        return $this->render('AppBundle:demo/response_type:token.html.twig', [
    ...
    public function grantTypeAuthorizationCodeAction(Request $request)
    {
        $parameters = [
            ...
            'redirect_uri' => $request->getUriForPath('/app/response_type/code'),
            'client_id' => 'authorization_code_grant',
        ...
        $refreshPath = $this->get('router')->generate('app_grant_type_refresh_token', [
            'username' => 'authorization_code_grant',
            'password' => 'uoce8AeP',
            'refresh_token' => $accessTokenResponse['refresh_token'],
        ]);

        return $this->render('AppBundle:demo/grant_type:authorization_code.html.twig', [
            'access_token_response' => $accessTokenResponse,
    ...
    public function grantTypePasswordAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo/grant_type:password.html.twig', [
            'access_token_response' => $accessTokenResponse,
            'access_token_request' => $accessTokenRequest,
            'model_path' => $modelPath,
            'debug_path' => $debugPath,
    ...
    public function grantTypeClientCredentialsAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo/grant_type:client_credentials.html.twig', [
            'access_token_response' => $accessTokenResponse,
            'access_token_request' => $accessTokenRequest,
            'model_path' => $modelPath,
            'debug_path' => $debugPath,
    ...
    public function grantTypeRefreshTokenAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo/grant_type:refresh_token.html.twig', [
            'access_token_response' => $accessTokenResponse,
            'access_token_request' => $accessTokenRequest,
            'model_path' => $modelPath,
            'debug_path' => $debugPath,
    ...
    public function resourceTypeModelAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo/resource_type:model.html.twig', [
    ...
    public function resourceTypeDebugEndpointAction(Request $request)
    {
        ...
        return $this->render('AppBundle:demo/resource_type:debug_endpoint.html.twig', [
            'resource_response' => $resourceResponse,
            'resource_request' => $resourceRequest,
        ]);
    }
